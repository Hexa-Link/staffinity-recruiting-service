...
public class Employee {
    ...
    private String firstName; // Mapped from C# JSON
    private String lastName; // Mapped from C# JSON
    private String phoneNumber; // Mapped from C# JSON
    ...
    public Employee(UUID id, String code, String email, String passwordHash, String phone,
